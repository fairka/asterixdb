...
public class RangeForwardOperatorDescriptor extends AbstractOperatorDescriptor {
    ...
    public RangeForwardOperatorDescriptor(IOperatorDescriptorRegistry spec, RangeId rangeId, RangeMap rangeMap,
    ...
    public static class RangeForwardTaskState extends AbstractStateObject {
        ...
        public RangeForwardTaskState(JobId jobId, RangeId rangeId, RangeMap rangeMap, int nPartitions) {
            super(jobId, rangeId);
            this.rangeMap = rangeMap;
