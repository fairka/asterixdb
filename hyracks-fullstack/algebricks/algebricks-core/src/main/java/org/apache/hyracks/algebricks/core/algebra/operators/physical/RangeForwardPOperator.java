...
public class RangeForwardPOperator extends AbstractPhysicalOperator {
    ...
    public RangeForwardPOperator(RangeId rangeId, RangeMap rangeMap) {
    ...
    public void contributeRuntimeOperator(IHyracksJobBuilder builder, JobGenContext context, ILogicalOperator op,
        ...
        RangeForwardOperatorDescriptor opDesc =
                new RangeForwardOperatorDescriptor(spec, rangeId, rangeMap, recordDescriptor);
