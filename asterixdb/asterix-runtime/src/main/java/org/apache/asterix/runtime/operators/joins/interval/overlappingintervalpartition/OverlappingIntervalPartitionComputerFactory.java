...
public class OverlappingIntervalPartitionComputerFactory implements ITuplePartitionComputerFactory {
    ...
    public OverlappingIntervalPartitionComputerFactory(int intervalFieldId, int k, long partitionStart,
            long partitionEnd) throws HyracksDataException {
    ...
    public ITuplePartitionComputer createPartitioner(IHyracksTaskContext hyracksTaskContext) {
        return new ITuplePartitionComputer() {
            ...
            private int getIntervalPartition(long point) throws HyracksDataException {
                return OverlappingIntervalPartitionUtil.getIntervalPartition(point, partitionStart, partitionDuration,
                        k);
            }
