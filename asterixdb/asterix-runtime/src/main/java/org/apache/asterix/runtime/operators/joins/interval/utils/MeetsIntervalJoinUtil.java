...
public class MeetsIntervalJoinUtil extends AbstractIntervalJoinUtil {

    public MeetsIntervalJoinUtil(int buildKey, int probeKey) {
    ...
    public boolean compareInterval(AIntervalPointable ipBuild, AIntervalPointable ipProbe) throws HyracksDataException {
        return il.meets(ipBuild, ipProbe);
    }
}
