...
public class IntervalTimeSweepJoinPOperator extends AbstractJoinPOperator {
    ...
    public IIntervalJoinUtilFactory getIntervalTimeSweepJoinCheckerFactory() {
        return mjcf;
    }
    ...
    public String toString() {
        return "INTERVAL_TIME_SWEEP" + " " + keysLeftBranch + " " + keysRightBranch;
    }
    ...
    IOperatorDescriptor getIntervalOperatorDescriptor(int[] keysBuild, int[] keysProbe,
        ...
        return new IntervalTimeSweepJoinOperatorDescriptor(spec, memSizeInFrames, keysBuild, keysProbe,
