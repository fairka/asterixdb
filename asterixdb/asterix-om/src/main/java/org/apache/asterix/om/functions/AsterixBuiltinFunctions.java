...
public class AsterixBuiltinFunctions {
    ...
    public static final FunctionIdentifier RECORD_MERGE =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "record-merge", 2);
    public static final FunctionIdentifier REMOVE_FIELDS =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "record-remove-fields", 2);
    public static final FunctionIdentifier ADD_FIELDS =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "record-add-fields", 2);
    ...
    public static final FunctionIdentifier OPEN_RECORD_CONSTRUCTOR =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "open-record-constructor", FunctionIdentifier.VARARGS);
    ...
    public static final FunctionIdentifier GET_RECORD_FIELDS =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "get-record-fields", 1);
    public static final FunctionIdentifier GET_RECORD_FIELD_VALUE =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "get-record-field-value", 2);
    public static final FunctionIdentifier RECORD_PAIRS =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "record-pairs", FunctionIdentifier.VARARGS);
    ...
    public static final FunctionIdentifier NULL_CONSTRUCTOR =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "null", 1);
    ...
    public static final FunctionIdentifier INTERVAL_PARTITION_JOIN_START =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "interval-partition-join-start", 3);
    public static final FunctionIdentifier INTERVAL_PARTITION_JOIN_END =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "interval-partition-join-end", 3);
    ...
    public static final FunctionIdentifier FLOW_RECORD =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "flow-record", 1);
    ...
    public static final FunctionIdentifier IS_UNKOWN =
    ...
    public static final FunctionIdentifier RESOLVE =
            new FunctionIdentifier(FunctionConstants.ASTERIX_NS, "resolve", FunctionIdentifier.VARARGS);
    ...
    static {
        ...
        addFunction(CARET, NumericAddSubMulDivTypeComputer.INSTANCE_MUL_POW, true);
        ...
        addPrivateFunction(NUMERIC_DIVIDE, NumericAddSubMulDivTypeComputer.INSTANCE_DIV_MOD, true);
